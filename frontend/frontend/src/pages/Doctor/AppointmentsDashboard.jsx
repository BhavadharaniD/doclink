...
import CalendarPanel from "../../components/CalendarPanenl";
...
const AppointmentsDashboard = () => {
    ...
    const fetchAppointments = async () => {
      try {
        const { data } = await axios.get(
          ...
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("doclinkToken")}`,
            },
          }
        );
  ...
  const handleAddNotes = async (id) => {
    ...
    try {
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/api/appointment/${id}/notes`,
        { notes },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("doclinkToken")}`,
